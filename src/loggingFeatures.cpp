...
addVarToCollect( gl.des_target_pos.x(rbd::X)        , "des_baseX"      );
addVarToCollect( gl.des_target_pos.x(rbd::Y)        , "des_baseY"      );
addVarToCollect( gl.des_target_pos.x(rbd::Z)        , "des_baseZ"      );
...
addVarToCollect( gl.des_target_posB.x(rbd::X)        , "des_baseBX"      );
addVarToCollect( gl.des_target_posB.x(rbd::Y)        , "des_baseBY"      );
addVarToCollect( gl.des_target_posB.x(rbd::Z)        , "des_baseBZ"      );
...
addVarToCollect( gl.des_target_posB.xd(rbd::X)        , "des_baseBXd"      );
addVarToCollect( gl.des_target_posB.xd(rbd::Y)        , "des_baseBYd"      );
addVarToCollect( gl.des_target_posB.xd(rbd::Z)        , "des_baseBZd"      );
...
addVarToCollect( gl.feetForces[iit::dog::LF](rbd::X)          , "feetForcesLFx"         );
addVarToCollect( gl.feetForces[iit::dog::LF](rbd::Y)          , "feetForcesLFy"         );
addVarToCollect( gl.feetForces[iit::dog::LF](rbd::Z)          , "feetForcesLFz"         );
addVarToCollect( gl.feetForces[iit::dog::RF](rbd::X)          , "feetForcesRFx"         );
addVarToCollect( gl.feetForces[iit::dog::RF](rbd::Y)          , "feetForcesRFy"         );
addVarToCollect( gl.feetForces[iit::dog::RF](rbd::Z)          , "feetForcesRFz"         );
addVarToCollect( gl.feetForces[iit::dog::LH](rbd::X)         , "feetForcesLHx"         );
addVarToCollect( gl.feetForces[iit::dog::LH](rbd::Y)         , "feetForcesLHy"         );
addVarToCollect( gl.feetForces[iit::dog::LH](rbd::Z)         , "feetForcesLHz"         );
addVarToCollect( gl.feetForces[iit::dog::RH](rbd::X)         , "feetForcesRHx"         );
addVarToCollect( gl.feetForces[iit::dog::RH](rbd::Y)          , "feetForcesRHy"        );
addVarToCollect( gl.feetForces[iit::dog::RH](rbd::Z)          , "feetForcesRHz"        );

addVarToCollect( gl.feetForcesBase[iit::dog::LF](rbd::X)          , "feetForcesBLFx"         );
addVarToCollect( gl.feetForcesBase[iit::dog::LF](rbd::Y)          , "feetForcesBLFy"         );
addVarToCollect( gl.feetForcesBase[iit::dog::LF](rbd::Z)          , "feetForcesBLFz"         );
addVarToCollect( gl.feetForcesBase[iit::dog::RF](rbd::X)          , "feetForcesBRFx"         );
addVarToCollect( gl.feetForcesBase[iit::dog::RF](rbd::Y)          , "feetForcesBRFy"         );
addVarToCollect( gl.feetForcesBase[iit::dog::RF](rbd::Z)          , "feetForcesBRFz"         );
addVarToCollect( gl.feetForcesBase[iit::dog::LH](rbd::X)          , "feetForcesBLHx"         );
addVarToCollect( gl.feetForcesBase[iit::dog::LH](rbd::Y)          , "feetForcesBLHy"         );
addVarToCollect( gl.feetForcesBase[iit::dog::LH](rbd::Z)          , "feetForcesBLHz"         );
addVarToCollect( gl.feetForcesBase[iit::dog::RH](rbd::X)         , "feetForcesBRHx"         );
addVarToCollect( gl.feetForcesBase[iit::dog::RH](rbd::Y)          , "feetForcesBRHy"        );
addVarToCollect( gl.feetForcesBase[iit::dog::RH](rbd::Z)          , "feetForcesBRHz"        );
...
addVarToCollect(q_max_(iit::dog::LF_HAA)     , "LF_HAA_th_max"         );
addVarToCollect(q_max_(iit::dog::LF_HFE)     , "LF_HFE_th_max"         );
addVarToCollect(q_max_(iit::dog::LF_KFE)     , "LF_KFE_th_max"         );
addVarToCollect(q_max_(iit::dog::RF_HAA)     , "RF_HAA_th_max"         );
addVarToCollect(q_max_(iit::dog::RF_HFE)     , "RF_HFE_th_max"         );
addVarToCollect(q_max_(iit::dog::RF_KFE)     , "RF_KFE_th_max"         );
addVarToCollect(q_max_(iit::dog::LH_HAA)     , "LH_HAA_th_max"         );
addVarToCollect(q_max_(iit::dog::LH_HFE)     , "LH_HFE_th_max"         );
addVarToCollect(q_max_(iit::dog::LH_KFE)     , "LH_KFE_th_max"         );
addVarToCollect(q_max_(iit::dog::RH_HAA)     , "RH_HAA_th_max"         );
addVarToCollect(q_max_(iit::dog::RH_HFE)     , "RH_HFE_th_max"         );
addVarToCollect(q_max_(iit::dog::RH_KFE)     , "RH_KFE_th_max"         );

addVarToCollect(q_min_(iit::dog::LF_HAA)     , "LF_HAA_th_min"         );
addVarToCollect(q_min_(iit::dog::LF_HFE)     , "LF_HFE_th_min"         );
addVarToCollect(q_min_(iit::dog::LF_KFE)     , "LF_KFE_th_min"         );
addVarToCollect(q_min_(iit::dog::RF_HAA)     , "RF_HAA_th_min"         );
addVarToCollect(q_min_(iit::dog::RF_HFE)     , "RF_HFE_th_min"         );
addVarToCollect(q_min_(iit::dog::RF_KFE)     , "RF_KFE_th_min"         );
addVarToCollect(q_min_(iit::dog::LH_HAA)     , "LH_HAA_th_min"         );
addVarToCollect(q_min_(iit::dog::LH_HFE)     , "LH_HFE_th_min"         );
addVarToCollect(q_min_(iit::dog::LH_KFE)     , "LH_KFE_th_min"         );
addVarToCollect(q_min_(iit::dog::RH_HAA)     , "RH_HAA_th_min"         );
addVarToCollect(q_min_(iit::dog::RH_HFE)     , "RH_HFE_th_min"         );
addVarToCollect(q_min_(iit::dog::RH_KFE)     , "RH_KFE_th_min"         );
