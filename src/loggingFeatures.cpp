...
addVarToCollect( des_com_pos.x(rbd::X)        , "des_comX"      );
addVarToCollect( des_com_pos.x(rbd::Y)        , "des_comY"      );
addVarToCollect( des_com_pos.x(rbd::Z)        , "des_comZ"      );
addVarToCollect( des_com_posB.x(rbd::X)        , "des_comBX"      );
addVarToCollect( des_com_posB.x(rbd::Y)        , "des_comBY"      );
addVarToCollect( des_com_posB.x(rbd::Z)        , "des_comBZ"      );
addVarToCollect( gl.actual_CoM.x(rbd::X)          , "actual_CoMX"    );
addVarToCollect( gl.actual_CoM.x(rbd::Y)          , "actual_CoMY"    );
addVarToCollect( gl.actual_CoM.x(rbd::Z)          , "actual_CoMY"    );
...
addVarToCollect( des_com_pos.xd(rbd::X)        , "des_comBXd"      );
addVarToCollect( des_com_pos.xd(rbd::Y)        , "des_comBYd"      );
addVarToCollect( des_com_pos.xd(rbd::Z)        , "des_comBZd"      );
